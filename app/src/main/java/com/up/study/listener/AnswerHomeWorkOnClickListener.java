...
public class AnswerHomeWorkOnClickListener implements View.OnClickListener{
     ...
     * @param ll_answer_d
     */
    public AnswerHomeWorkOnClickListener(TextView tv_answer_right, TextView tv_answer_select,
    ...
    public AnswerHomeWorkOnClickListener(View view, TextView tv_answer_right, TextView tv_answer_select){
          this.tv_answer_right = tv_answer_right;
          this.tv_answer_select = tv_answer_select;
